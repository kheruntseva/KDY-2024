...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = // таблица ошибок
	{
		...
		ERROR_ENTRY(119, "Ошибка. В стандартной библиотеке KDY-2024 такой функции нет"),
		...
		ERROR_ENTRY(610, " error Ошибка при вызове функции! Количество параметров не совпадает"),
